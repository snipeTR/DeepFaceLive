...
class Localization:
    ...
    allowed_langs = ['en-US', 'ru-RU', 'zh-CN', 'es-ES', 'it-IT', 'ja-JP', 'de-DE', 'tr-TR']
    ...
    def localize(s : Union[str, None]) -> Union[str, None]:
        ...
        if len(s) > 0 and s[0] == '@':
            ...
            if x is not None:
                return x.get(Localization.lang, s)
            else:
    ...
    _id_to_string_dict = {
        ...
        'common.help.device': {
            ...
            'tr-TR': 'Daha yüksek FPS veya daha düşük CPU kullanımı elde etmek için modül cihazlarının kombinasyonunu ayarlayın.'
        },
        ...
        'QDFLAppWindow.reset_modules_settings': {
            ...
            'tr-TR': 'Modül ayarlarını sıfırla'
        },
        ...
        'QDFLAppWindow.visit_github_page': {
            ...
            'tr-TR': 'GitHub sayfasını ziyaret et'
        },
        ...
        'QFileSource.help.target_width': {
            ...
            'tr-TR': 'Çerçeveyi istenen genişliğe yeniden boyutlandırın.'
        },
        ...
        'QFileSource.help.fps': {
            ...
            'tr-TR': 'İstenen saniyedeki kare sayısını ayarlayın.'
        },
        ...
        'QFileSource.help.is_realtime': {
            ...
            'tr-TR': 'Gerçek zamanlı FPS ile mi yoksa mümkün olan en hızlı şekilde mi oynatılacağını belirler.'
        },
        ...
        'QCameraSource.help.driver': {
            ...
            'tr-TR': 'Kamerayı çalıştırmak için işletim sistemi sürücüsü. Bazı sürücüler daha yüksek çözünürlüğü destekleyebilir, ancak üretici ayarlarını desteklemez.'
        },
        ...
        'QCameraSource.help.resolution': {
            ...
            'tr-TR': 'Kamera cihazının çıkış çözünürlüğü.'
        },
        ...
        'QCameraSource.help.fps': {
            ...
            'tr-TR': 'Kamera cihazının çıkış kare hızı.'
        },
        ...
        'QFaceDetector.help.detector_type': {
            ...
            'tr-TR': 'Farklı algılayıcı türleri farklı şekilde çalışır.'
        },
        ...
        'QFaceDetector.help.window_size': {
            ...
            'tr-TR': 'Küçük pencere boyutu daha hızlıdır, ancak daha az doğru çalışır.'
        },
        ...
        'QFaceDetector.help.threshold': {
            ...
            'tr-TR': 'Değer ne kadar düşükse, o kadar çok yanlış yüz algılanır.'
        },
        ...
        'QFaceDetector.help.max_faces': {
            ...
            'tr-TR': 'Algılanabilecek maksimum yüz sayısı.'
        },
        ...
        'QFaceDetector.help.sort_by': {
            ...
            'tr-TR': 'Yüzleri metoda göre sırala. Örneğin, "SAĞDAN SOLA" durumunda Yüz Kimliği 0 ekranın en sağında yer alır.'
        },
        ...
        'QFaceDetector.help.temporal_smoothing': {
            ...
            'tr-TR': 'Kareler arasında ortalama alarak yüz çerçevesini stabilize eder. Statik sahnelerde veya web kamerasıyla kullanım için uygundur.'
        },
        ...
        'QFaceAligner.help.align_mode': {
            ...
            'tr-TR': 'Dikdörtgenden hizalama, Face Animator için uygundur. Noktalardan hizalama, face swapper için daha iyidir.'
        },
        ...
        'QFaceAligner.help.face_coverage': {
            ...
            'tr-TR': 'Hizalanmış yüzün çıkış alanı. İstediğiniz gibi ayarlayın.'
        },
        ...
        'QFaceAligner.help.resolution': {
            ...
            'tr-TR': 'Hizalanmış yüzün çözünürlüğü. Modelin çözünürlüğüyle uyumlu olmalıdır.'
        },
        ...
        'QFaceAligner.exclude_moving_parts': {
            ...
            'tr-TR': 'Hareketli kısımları hariç tut'
        },
        ...
        'QFaceAligner.help.exclude_moving_parts': {
            ...
            'tr-TR': 'Yüzün hareketli kısımlarının (örneğin ağız) belirteçlerini hariç tutarak stabilizasyonu artırın.'
        },
        ...
        'QFaceAligner.help.head_mode': {
            ...
            'tr-TR': 'Baş modu. HEAD modeli ile kullanılır.'
        },
        ...
        'QFaceMarker.marker_coverage': {
            ...
            'tr-TR': 'İşaretleyici kapsama alanı'
        },
        ...
        'QFaceMarker.help.marker_coverage': {
            ...
            'tr-TR': 'Algılanan yüzün, FaceMarker’a girecek dikdörtgen boyutunu kontrol eder. Yeşil yüz noktaları yüzle tam olarak eşleşmelidir. “Hizalanmış Yüz” penceresine bakıp istediğiniz gibi ayarlayın.'
        },
        ...
        'QFaceMarker.help.temporal_smoothing': {
            ...
            'tr-TR': 'Kareler arasında ortalama alarak yüz belirteçlerini stabilize eder. Statik sahnelerde veya web kamerasıyla kullanım için uygundur.'
        },
        ...
        'QFaceSwapDFM.help.model': {
            ...
            'tr-TR': 'Bir klasörden ya da internetten indirilebilen model dosyası.\nDeepFaceLab ile kendi modelinizi eğitebilirsiniz.'
        },
        ...
        'QFaceSwapDFM.help.face_id': {
            ...
            'tr-TR': 'Değiştirilecek yüzün Kimliği.'
        },
        ...
        'QFaceSwapDFM.morph_factor': {
            ...
            'ja-JP': 'モーフィング係数',
            'de-DE': 'Morph-Faktor',
            'tr-TR': 'Şekil değiştirme faktörü'
        },
        ...
        'QFaceSwapDFM.help.morph_factor': {
            ...
            'tr-TR': 'Kaynak yüzünden ünlü yüze geçişteki yüz deformasyon derecesini kontrol eder.'
        },
        ...
        'QFaceSwapDFM.help.presharpen_amount': {
            ...
            'tr-TR': 'Görüntüyü sinir ağına vermeden önce keskinleştir.'
        },
        ...
        'QFaceSwapDFM.help.pregamma': {
            ...
            'tr-TR': 'Görüntüyü sinir ağına vermeden önce gamma değerini değiştirin.'
        },
        ...
        'QFaceSwapDFM.help.two_pass': {
            ...
            'tr-TR': 'Yüzü iki kez işleyin. FPS değeri yaklaşık yarıya iner.'
        },
        ...
        'QFrameAdjuster.help.median_blur_per': {
            ...
            'tr-TR': 'Medyan filtre kullanarak tüm kareyi bulanıklaştırın.'
        },
        ...
        'QFrameAdjuster.help.degrade_bicubic_per': {
            ...
            'tr-TR': 'Bicubic yeniden boyutlandırma kullanarak tüm kareyi bozun.'
        },
        ...
        'QFaceMerger.help.color_transfer': {
            ...
            'tr-TR': 'Değiştirilen yüzün renk dağılımını orijinal yüze eşleştirin.'
        },
        ...
        'QStreamOutput.help.avg_fps': {
            ...
            'tr-TR': 'Çıkış akışının ortalama FPS değeri.'
        },
        ...
        'QStreamOutput.help.aligned_face_id': {
            ...
            'tr-TR': 'Gösterilecek hizalanmış yüzün ID\'si.'
        },
        ...
        'QStreamOutput.help.target_delay': {
            ...
            'tr-TR': 'Giriş ve çıkış kareleri arasındaki milisaniye cinsinden hedef gecikme. Akış yazılımınızdaki ses gecikmesiyle eşleştirerek senkronize akış elde edin.'
        },
        ...
        'QStreamOutput.help.save_sequence_path': {
            ...
            'tr-TR': 'Çıkış akışının görüntü dizisini belirtilen dizine kaydedin.'
        },
        ...
        'QStreamOutput.save_fill_frame_gap': {
            ...
            'tr-TR': 'Kare boşluklarını doldur'
        },
        ...
        'QStreamOutput.help.save_fill_frame_gap': {
            ...
            'tr-TR': 'Son kareyi kopyalayarak kare düşmelerini doldurun.'
        },
        ...
        'StreamOutput.SourceType.MERGED_FRAME_OR_SOURCE_FRAME': {
            ...
            'tr-TR': 'Birleştirilmiş kare veya kaynak kare'
        },
        ...
        'StreamOutput.SourceType.SOURCE_N_MERGED_FRAME': {
            ...
            'tr-TR': 'Kaynak ve birleştirilmiş kare'
        },
        ...
        'StreamOutput.SourceType.SOURCE_N_MERGED_FRAME_OR_SOURCE_FRAME': {
            ...
            'tr-TR': 'Kaynak ve birleştirilmiş kare ya da yalnızca kaynak kare'
        },
        ...
        'StreamOutput.SourceType.ALIGNED_N_SWAPPED_FACE': {
            ...
            'tr-TR': 'Hizalanmış ve değiştirilmiş yüz'
        },
    }
